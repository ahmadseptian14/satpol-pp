...
@section('content')
       <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <a href="{{route('member.create')}}" class="btn btn-primary btn-sm shadow-sm"><i class="fa fa-user-plus mr-1">Tambah Anggota</i></a>
          </div>
        ...
        <form action="{{route('member.search')}}" class="form-inline my-2 my-lg-0" method="POST">
            @csrf
          <input class="form-control mr-sm-2" placeholder="Cari Nama Anggota" aria-label="Search" name="search">
          <button class="btn btn-outline-warning my-2 my-sm-0" type="submit">Search</button>
          {{-- <input type="submit" name="search" value="search" class="btn btn-outline-success my-2 my-sm-0"> --}}
      </form>
          <div class="row">
              <div class="card-body">
                      ...
                      <table class="table table-bordered" width="100%">
                        ...
                        <tbody>
                            @forelse ($items as $key => $item)
                                ...
                                <td>
                                    <a href="{{route('performance.show', $item->id)}}" class="btn btn-sm btn-info mb-2"><i class="fa fa-eye"></i>Data Kinerja</a>   
